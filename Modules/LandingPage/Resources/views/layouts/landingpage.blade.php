...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ $sup_logo . '/' . $adminSettings['company_favicon']  . '?timestamp=' . time() }}" type="image/x-icon" />
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6">
                            <div
                                ...
                                <div class="card-body">
                                    ...
                                    <span
                                        class="mb-4 f-w-600 p-price">{{ env('CURRENCY_SYMBOL') . $value->price }}<small
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-3 text-center ">
                                            <b>
                                                <span class="h5 mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }}">{{ $value->max_products }}</span>
                                            </b>
                                            <span class="d-block text-sm">{{__('Products')}}</span>
                                        </div>
                                        <div class="col-3 text-center">
                                            <span class="h5 mb-0">
                                                <span class="h5 mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }}">{{ $value->max_stores }}</span>
                                            </span>
                                            <span class="d-block text-sm">{{__('Store')}}</span>
                                        </div>
                                        <div class="col-3 text-center">
                                            <span class="h5 mb-0">
                                                <span class="h5 mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }}">{{ $value->max_users }}</span>
                                            </span>
                                            <span class="d-block text-sm">{{__('Users')}}</span>
                                        </div>
                                        <div class="col-3 text-center">
                                            <span class="h5 mb-0">
                                                <span class="h5 mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }}">{{ $value->storage_limit }}</span>
                                            </span>
                                            <span class="d-block text-sm">{{__('Storage')}}</span>
                                        </div>
                                    </div>
                                    <div class="d-grid">
                                        <a href="{{ route('register') }}" class="btn btn-primary rounded-pill">{{__('Start with Starter')}}
