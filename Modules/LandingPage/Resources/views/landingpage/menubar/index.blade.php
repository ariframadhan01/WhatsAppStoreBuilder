                                ...
                                <div class="form-group">
                                    ...
                                    <div class="choose-files mt-5">
                                        <label for="site_logo_light">
                                            ...
                                            <input type="file" name="site_logo_light" id="site_logo_light" class="form-control file"
                                                data-filename="site_logo_light">
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="choose-files mt-5">
                                        <label for="site_logo_dark">
                                            ...
                                            <input type="file" name="site_logo_dark" id="site_logo_dark" class="form-control file"
                                                data-filename="site_logo_dark">
                                        </label>
                                    </div>
