        ...
        if (\Auth::user()->can('Manage Settings')) {
            ...
            if (Auth::user()->type == 'super admin') {
                ...
                if ($store_settings) {
                    ...
                    return view('settings.index', compact('settings', 'store_settings', 'store_payment_setting', 'serverIp', 'subdomain_name', 'subdomain_Ip', 'subdomainPointing', 'domainip', 'domainPointing', 'pwa_data', 'PixelFields'));
