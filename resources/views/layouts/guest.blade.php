...
<body class="{{ $color }}">
            ...
            <div class="auth-footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-6">
                            &copy; {{ __('Copyright') }}
                            {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Whatsstore') }}
                            {{ date('Y') }}
                        </div>
                    </div>
                </div>
    ...
    @endphp
    @if ($admin_settings['enable_cookie'] == 'on' && $admin_settings['cookie_logging'] == 'on')
