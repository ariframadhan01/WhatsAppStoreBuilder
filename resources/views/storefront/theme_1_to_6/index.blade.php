@php
    ...
    // $current_theme = Cookie::get('current_theme');
    // if (!isset($current_theme)) {
    $current_theme = $store->store_theme;
    // }
...
<body class="themes-color">
                        ...
                        <div class="navbar-container d-flex align-items-center justify-content-between">
                            ...
                            <div class="search-bar">
                                {{-- <div class="search-header">
                                    <a href="#" id="btn-search" data-size="lg" data-ajax-popup="true">
                                    ...
                                    <div class="profile-header has-item">
                                        ...
                                        <div class="menu-dropdown">
                                            <ul>
                                                ...
                                                <li>
                                                    <a data-url="{{ route('customer.profile', [$store->slug, \Illuminate\Support\Facades\Crypt::encrypt(Auth::guard('customers')->user())]) }}"
                                                        class="modal-target" data-ajax-popup="true" data-size="lg"
                                                        data-title="User Information"
                                                        data-modal="modal">{{ __('My Profile') }}</a>
                                                </li>
                                                <li>
                                ...
                                @else
                                    {{-- <a href="{{ route('customer.login', $store->slug) }}" class="btn btn-secondary"
                                        style="display: block;">{{ __('Log in') }}</a> --}}
    ...
    <div class="wrapper">
        ...
        col-lg-10 col-12">
                        <div class="content-wrapper">
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-12 right-card">
                                        ...
                                        <div class="order-md-1 text-center" style="border: 0; padding:0;">
                                            @if (
                                                ...
                                                <a href="#" class="btn checkoutBtn" data-toggle="modal"
                                                    id="checkoutBtn" data-target="#checkoutModal"
                                                    data-title="CheckOut Model">
                                        ...
                                        <div class="order-md-2 card" id="asGuest">
                                            ...
                                            <div class="btn-leb">
                                                ...
                                                @if ($store['enable_bank'] == 'on')
                                                    <div
                                                        class="payment-title d-flex align-items-center justify-content-between">
                                                        <div class="row">
                            ...
                            <div class="copyright d-flex align-items-center justify-content-between" id="footer">
    ...
    @php
        ...
        $cookie_settings = Utility::settings();
    @endphp
