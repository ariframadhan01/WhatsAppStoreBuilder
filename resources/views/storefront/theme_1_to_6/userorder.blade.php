                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card card-fluid">
                                        ...
                                        <div class="card-body">
                                            <dl class="row mt-4 align-items-center">
                                                <dt class="col-sm-3 h6 text-sm">{{ !empty($store['custom_field_title_1']) ? $store['custom_field_title_1'] : '' }}
                                                </dt>
                                                <dd class="col-sm-9 text-sm">
                                                    {{ $user_details->custom_field_title_1 }}</dd>
                                                <dt class="col-sm-3 h6 text-sm">{{ !empty($store['custom_field_title_2']) ? $store['custom_field_title_2'] : '' }}
                                                </dt>
                                                <dd class="col-sm-9 text-sm">
                                                    {{ $user_details->custom_field_title_2 }}</dd>
                                                <dt class="col-sm-3 h6 text-sm">{{ !empty($store['custom_field_title_3']) ? $store['custom_field_title_3'] : '' }}
                                                </dt>
                                                <dd class="col-sm-9 text-sm">
                                                    {{ $user_details->custom_field_title_3 }}</dd>
                                                <dt class="col-sm-3 h6 text-sm">{{ !empty($store['custom_field_title_4']) ? $store['custom_field_title_4'] : '' }}
                                                </dt>
                                                <dd class="col-sm-9 text-sm">
