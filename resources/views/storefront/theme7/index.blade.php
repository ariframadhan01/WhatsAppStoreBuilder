@php
    ...
    $current_theme = $store->current_theme;
        ...
        <div class="container-fluid">
            <div class="single-page-wrapper">
                <div class="tabs-wrapper">
                    <div class="side-menu-wrapper banner-col-left">
                                        ...
                                        @foreach ($pro_cart['products'] as $key => $product)
                                            @if ($product['variant_id'] != 0)
                                                <div class="cart-item">
                                                    ...
                                                    <div class="cart-item-right">
                                                        <div class="price">
                                                            <ins>{{ \App\Models\Utility::priceFormat($product['variant_price'] * $product['quantity']) }}<span
                                            ...
                                            @else
                                                <div class="cart-item">
                                                    ...
                                                    <div class="cart-item-right">
                                                        <div class="price">
                                                            <ins>{{ \App\Models\Utility::priceFormat($product['price'] * $product['quantity']) }}<span
                                                                    class="currency-type"></span></ins>
                                                        </div>
                                                        <div class="cart-item-cntr">
                                                            <div class="qty-spinner" data-id="{{ $key }}">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <span class="cart-sum-right total-amount" data-original="$0.00">
                                                ...
                                                <b class="final_total_price pro_total_price"
                                        ...
                                        <li>
                                            @if (!empty($taxArr))
                                                @foreach ($taxArr['tax'] as $k => $tax)
                                                    <span class="cart-sum-left"> {{ $tax }}</span>
                                                    <span
                                                        class="cart-sum-right shipping_price">{{ \App\Models\Utility::priceFormat($taxArr['rate'][$k]) }}</span>
                                                @endforeach
                                            @endif
                                        </li>
                                        <li>
                                        ...
                                        @if (isset($store_payments['is_coingate_enabled']) && $store_payments['is_coingate_enabled'] == 'on')
                                            <div class="col-sm-6 col-12">
                                                <form id="payment-coingate-form" method="POST"
                                                    ...
                                                    <input type="hidden" name="wts_number"
                                                        class="customer_wts_number">
                                                    <button class="payment-btn" type="submit" id="owner-coingate">
                                                        {{ __('Pay via CoinGate') }}
                                                    </button>
                                                </form>
                                            </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ $store->youtube }}" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    viewBox="0 0 409.592 409.592" style="enable-background:new 0 0 409.592 409.592;"
                                    xml:space="preserve">
                                    <g>
                                        <g>
                                            <path
                    ...
                    @if (!empty($store->email))
                        <li class="nav-item">
                            <a class="nav-link" href="mailto:{{ $store->email }}" target="”_blank”">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" id="Capa_1" x="0px" y="0px"
                                    viewBox="0 0 433.664 433.664" style="enable-background:new 0 0 433.664 433.664;"
                                    xml:space="preserve">
                                    <g>
                                        <g>
                                            <path
