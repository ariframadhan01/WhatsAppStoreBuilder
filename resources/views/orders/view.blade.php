...
@section('action-btn')
    <div class="row  m-1">
        <div class="col-auto pe-0 ">
            <a href="#" id="{{ env('APP_URL') . '/' . $store->slug . '/order/' . $order_id }}"
                class="btn btn-sm btn-primary btn-icon mb-1" onclick="copyToClipboard(this)" title="Copy link"
                data-bs-toggle="tooltip" data-original-title="{{ __('Click to copy') }}"><i
                    class="ti ti-link text-white"></i></a>
        </div>
        <div class="col-auto pe-0">
            <a href="{{ route('order.receipt', $order->id) }} " class="btn btn-sm btn-primary btn-icon"
                data-bs-toggle="tooltip" data-bs-original-title="{{ __('Receipt') }}">
                <i class="ti ti-receipt text-white"></i>
            </a>
        </div>

        <div class="col-auto pe-0">
            <a href="# " onclick="saveAsPDF();" class="btn btn-sm btn-primary btn-icon" id="download-buttons"
        ...
        <div class="col-auto pe-0">
            <div class="btn-group " id="deliver_btn">
                <button class="btn btn-primary dropdown-toggle py-1" type="button" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">{{ __('Status') }} :
                    {{ __(ucfirst($order->status)) }}</button>
        ...
        <div class="col-sm-12">
            <div class="row" id="printableArea">
                                            ...
                                            <tr>
                                                <td colspan="4"><b>
                                                    ...
                                                    @if (!empty($user_details->special_instruct))
                                                        <dd class="p-2 d-inline"> {{ $user_details->special_instruct }}
                                                        </dd>
                                                    @endif
                                                </td>
                                            </tr>
                ...
                <div class="col-xxl-5">
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @if (!empty($shipping_data) && !empty($discount_value))
                                            ...
                                            <tr>
                                                <th>{{ __('Total') }} :</th>
                                                <th>{{ App\Models\Utility::priceFormat($sub_total + $total_taxs + $shipping_data->shipping_price - $discount_value) }}
                                                </th>
                                            </tr>
                                        @elseif(!empty($discount_value))
                                            ...
                                            <tr>
                                                <th>{{ __('Total') }} :</th>
                                                <th>{{ App\Models\Utility::priceFormat($sub_total + $total_taxs - $discount_value) }}
                                                </th>
                                            </tr>
                                        @elseif(!empty($shipping_data))
                                            ...
                                            <tr>
                                                <th>{{ __('Total') }} :</th>
                                                <th>{{ App\Models\Utility::priceFormat($sub_total + $total_taxs + $shipping_data->shipping_price) }}
                                                </th>
                                            </tr>
                                        @else
                                            <tr>
                    ...
                    @if (
                        !empty($store_payment_setting['custom_field_title_1']) ||
                            !empty($user_details->custom_field_title_1) ||
                            !empty($store_payment_setting['custom_field_title_2']) ||
                            !empty($user_details->custom_field_title_2) ||
                            !empty($store_payment_setting['custom_field_title_3']) ||
                            !empty($user_details->custom_field_title_3) ||
                            !empty($store_payment_setting['custom_field_title_4']) ||
