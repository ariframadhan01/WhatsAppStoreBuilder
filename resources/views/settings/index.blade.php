...
@section('action-btn')
    <ul class="nav nav-pills cust-nav   rounded  mb-3" id="pills-tab" role="tablist">
        @if (Auth::user()->type != 'super admin')
            <li class="nav-item">
                <a class="nav-link active" id="brand_settings-tab" data-bs-toggle="pill" href="#brand_settings"
            ...
            <li class="nav-item">
                <a class="nav-link" id="whatsapp_custom_massage-tab" data-bs-toggle="pill" href="#whatsapp_custom_massage"
                    role="tab" aria-controls="whatsapp_custom_massage"
                    aria-selected="false">{{ __('WhatsApp Mail Settings') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="twilio_settings-tab" data-bs-toggle="pill" href="#twilio_settings" role="tab"
                    aria-controls="twilio_settings" aria-selected="false">{{ __('Twilio Settings') }}</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" id="chatgpt_settings-tab" data-bs-toggle="pill" href="#chatgpt_settings"
                    role="tab" aria-controls="chatgpt_settings"
        ...
        @if (Auth::user()->type == 'super admin')
            ...
            <li class="nav-item">
                <a class="nav-link" id="storage_settings-tab" data-bs-toggle="pill" href="#storage_settings"
                    role="tab" aria-controls="storage_settings"
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small>{{ __('This value will assign when any new store created by Store Owner.') }}</small>
                ...
                <div class="tab-pane fade" id="store_settings" role="tabpanel" aria-labelledby="store_settings-tab">
                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12">
                                <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            @if ($setting['enable_chatgpt'] == 'on')
                                                <div class="col-lg-6 col-sm-6 col-md-6 text-end">
                                                    <a class="btn btn-sm btn-primary" href="#" data-size="lg"
                                    ...
                                    <div class="card-body pt-0">
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                {{-- <div class="form-group col-md-12 mt-3">
                                                    ...
                                                    <div class="custom-control form-switch">
                                                        ...
                                                        {{ Form::label('pwa_store', __('Enable Customer App'), ['class' => 'form-check-label mb-3']) }}
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-flex justify-content-end form-group col-md-12 text-end">
                                            {{ Form::submit(__('Save Changes'), ['class' => 'btn btn-sm btn-primary my-3 px-4 ']) }}
                                            {{ Form::close() }}
                                            ...
                                            <button type="button"
                                                class="btn bs-pass-para btn-secondary btn-light show_confirm my-3 px-4 ms-2">
                ...
                <div class="tab-pane fade" id="store_email_settings" role="tabpanel"
                    ...
                    <div id="store_email-settings" class="card">
                ...
                <div class="tab-pane fade" id="pixel_settings" role="tabpanel" aria-labelledby="pixel_settings-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="{{ __('Create') }}" data-size="md"
                                        data-ajax-popup="true" data-title="{{ __('Create New Pixel') }}"
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" data-toggle="switchbutton"
                                                class="custom-control-input recaptcha_enabled" name="recaptcha_module"
                    ...
                    <div class="card" id="clear_cache">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <p>This is a page meant for more advanced users, simply ignore it if you don't
                ...
                <div class="tab-pane fade" id="cookie_consent" role="tabpanel" aria-labelledby="cookie_consent-tab">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex justify-content-end">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="enable_chatgpt" id="enable_chatgpt"
                                                class="enable_chatgpt" data-toggle="switchbutton"
                                                {{ $settings['enable_chatgpt'] == 'on' ? 'checked=checked' : '' }}
                                                data-onstyle="primary">
                                            <label class="form-check-labe" for="enable_chatgpt"></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @push('script-page')
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                if ($('.recaptcha_enabled').is(':checked')) {
                ...
                if ($('.enable_chatgpt').is(':checked')) {

                    $('.chatgpt').removeClass('disabledCookie');
                } else {

                    $('.chatgpt').addClass('disabledCookie');
                }

                $('.enable_chatgpt').on('change', function() {
                    if ($('.enable_chatgpt').is(':checked')) {
        ...
        <script>
            ...
            custdarklayout.addEventListener("click", function() {
                if (custdarklayout.checked) {
                    ...
                    var element = document.querySelector(".navbar-content > .navbar-footer");
