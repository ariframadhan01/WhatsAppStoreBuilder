                        ...
                        @if( \Auth::user()->type == 'super admin')
                            <div class="d-flex flex-row-reverse m-0 p-0 ">
                                <div class="action-btn bg-primary ms-2">
                                  <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit Plan')}}" data-ajax-popup="true" data-size="lg" data-title="{{__('Edit Plan')}}" data-url="{{ route('plans.edit',$plan->id) }}"><i class="ti ti-edit text-white"></i></a>
                                </div>
                            </div>
                        @endif
