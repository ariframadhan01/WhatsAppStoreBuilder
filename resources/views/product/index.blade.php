...
@section('action-btn')
    <div class="row gy-4 align-items-center">
        <div class="col-auto">
            <div class="d-flex">
                <a href="{{ route('product.export', $store_id->id) }}" class="btn btn-sm btn-icon  bg-light-secondary me-2"
                ...
                @endcan
                @can('Create Products')
                <a href="{{ route('product.create') }}" class="btn btn-sm btn-icon  btn-primary me-2"
